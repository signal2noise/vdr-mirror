...
//----------------------------------------------------------------------
/*
  GA: Find "00 00 01" signature efficiently
  Data: base
  s: start index
  l: total length
  returns: -1 (not found) or start position of signature relative to Data
  Speedup: about 2.8 on AMD Geode 300MHz
*/
...
int FindPacketHeader(const uchar *Data, int s, int l)
{
	int i;
	uchar x;
