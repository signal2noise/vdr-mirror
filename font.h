...
private:
  static int generation; // GT: incremented when a new font is loaded (used for font caching) //reelskin
...
public:
  ...
  static int GetGeneration() // GT: used for font caching // reelskin
  {
      return generation;
  }
