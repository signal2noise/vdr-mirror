...
const tI18nPhrase Phrases[] = {
  ...
  { "can't record - check your configuration",
    "Aufzeichnen nicht möglich, bitte Empfang prüfen",
    "",
    "",
    "",
    "",// TODO
  ...
  { "What's on next?",
    ...
    "Kaj sledi?",
    "Quasi sono i prossimi programmi?",
    "Wat komt hierna?",
    "Próximo Programa?",
  ...
  { "End recording", //this is followed by the name of the recording
    "Beende Aufzeichnung",
    "Prekini snemanje",
  ...
  { "Recording - restart anyway?",
    ...
    "Registrazione in corso - spengo comunque?",
    "Opname loopt - toch herstarten?",
  ...
  { "Activated standby after current recording",
    "Standby nach Aufnahme aktiviert.",
    "",
    "",
    "",
    "",
  ...
  { "Recording - shut down anyway?",
    "Aktive Aufnahme beenden und herunterfahren?",
  ...
  { "Press any key to cancel shutdown",
    ...
    "Premere un tasto qualsiasi per annullare lo spegnimento",
  ...
  { "No free DVB device to record!",
    ...
    "Ni proste DVB naprave za snemanje!",
     "Nessuna periferica DVB disponibile per la registrazione!",
  ...
  { "Channel settings are not unique!",
    ...
    "Paramentri del canale non unici!",
  ...
  { "Can't shutdown - option '-s' not given!",
    ...
    "Impossibile spegnere - parametro '-s' non assegnato!",
  ...
  { "Setup.OSD$Optional languages", //note the plural "s"
    "Optionale Sprachen",
    "",
    "Lingue opzionali",
    "Optionele Talen",
  ...
  { "Setup.OSD$ Optional language", //note the singular and the leading " "
    " Optionale Sprache",
    "",
    " Lingua opzionale",
    " Optionele Talen",
  ...
  { "Setup.OSD$Use small font",
    ...
    "Uporabi male èrke",
    "Utilizzare caratteri minuscoli",
  ...
  { "Setup.OSD$Channel info time (s)",
    "Anzeigedauer beim Kanalwechsel",
    "Èas prikaza podatka o kanalu (s)",
    "Durata informazioni canale (s)",// TODO
    "Tijdsduur tonen kanaal-informatie (s)",
    "",// TODO
  ...
  { "Setup.EPG$Alternate Navigation",
    "Alternative Navigation",
    "",// TODO
    "Navigazione alternata",// TODO
  ...
  { "Setup.Recording$Sort recordings by",
    ...
    "",// TODO
    "Ordinare le registrazioni per",// TODO
    "Opname's sorteren naar",
    "",// TODO
    "",// TODO
    "",// TODO
    "",// TODO
 ...
 { "Normal",
  ...
  { "Setup.Replay$Show replay mode",
    ...
    "Modalita' di visualizzazione riproduzione",
 ...
 { "bouquet list",
  ...
  {
    "Setup.OSD$Channellist starts with",
  ...
  { "Phase 1: Detecting RC code type",
    ...
    "Fase 1: Vaststellen AB type code",
  ...
  { "Press any key on the RC unit",
    ...
    "Premere un tasto qualsiasi dell'unita` RC",
    "Druk willekeurige toets op de AB",
  ...
  { "Phase 2: Learning specific key codes",
    ...
    "Fase 2: Apprendimento codici dei tasti specifici",
  ...
  { "(press 'Down' to end key definition)",
    ...
    "(premere 'Giu' per terminare la definizione tasti)",
  ...
  { "Press 'Up' to save, 'Down' to cancel",
    ...
    "'Omhoog' bewaren, 'Omlaag' annuleren",
  ...
  { "Setup.OSD$Main Menu command position",
    ...
    "",//TODO
    "Comando posizione Menu Principale ",//TODO
    "Commando positie in Hoofd Menu",
    "",//TODO
    "",//TODO
    "",//TODO
  ...
  { "Setup.EPG$Show progress bar",
    "Zeitbalken anzeigen",
    "",//TODO
    "Mostra barra di avanzamento",//TODO
    "Toon voortgang's balk",
    "",//TODO
    "",//TODO
    "",//TODO
    "Näytä aikajana",
 ...
 { "EPG Service",
  ...
  { "Delete all shoutcast lists",
    "Alle Shoutcast Listen löschen",
    "",
    "",
    "",
    "",
  ...
  { "Already last help item",
    "Dies ist bereits die letzte Hilfe Position",
    "",
    "",
    "",
    "",
  ...
  { "Already first help item",
    "Dies ist bereits die erste Hilfe Position",
    "",
    "",
    "",
    "",
  ...
  { "CI-Slot for this Bouquet",
    "CI-Slot für dieses Bouquet",
    "",
    "",
    "",
    "",
  ...
  { "Select CI-Slot for current Bouquet.",
    "CI-Slot für aktuelles Bouquet auswählen.",
    "",
    "",
    "",
    "",
...
// skin start
  ...
  // Reccmds.conf (Recording commands)
  { "Mark commercials",
    "Werbung markieren",
    "",
    "",
