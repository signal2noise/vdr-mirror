...
ifdef RBLITE
OBJS = audio.o channels.o ci-lite.o config.o cutter.o device.o diseqc.o dvbdevice.o dvbosd.o
else
OBJS = audio.o channels.o ci.o config.o cutter.o device.o diseqc.o dvbdevice.o dvbosd.o
endif
OBJS += dvbplayer.o dvbspu.o eit.o eitscan.o epg.o filter.o font.o i18n.o interface.o keys.o\
       ...
       timers.o tools.o transfer.o vdr.o videodir.o submenu.o help.o
