...
protected:
  ...
  virtual cOsd *CreateTrueColorOsd(int Left, int Top); // GT: True color support.
public:
  cOsdProvider(void);
  ...
  static cOsd *NewTrueColorOsd(int Left, int Top, int Random, bool dontHide = false); // GT: True color osd support.
